...
declare module '#imports' {
  ...
  export { fetchAndExtractApiKey, searchProjects } from '../utils/api';
  export { addSearchTabToNav, modifyExplorePage, handleExploreTabRedirect, hideExploreContent } from '../utils/navigation';
  export { getSearchRemaining, decrementSearchRemaining, updateSearchRemaining, getActiveFilters, filterProjects } from '../utils/search';
  export { applyRecipieFinderTheme } from '../utils/theme';
  export { escapeHtml, displaySearchResults, displaySearchBox, displayApiKeyError } from '../utils/ui';
}
